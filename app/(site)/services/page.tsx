...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: page?.metaDescription ?? 'Explore EduCoach\'s full range of study-abroad services — career counselling, profile building, admissions, test prep, scholarships and visa support.',
  }
}
