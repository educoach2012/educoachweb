...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: page?.metaTitle ?? 'Case Studies — Real Students, Real Outcomes',
    description: page?.metaDescription ?? 'Read detailed case studies of how EduCoach helped students overcome challenges and secure admissions to top universities with scholarships.',
  }
}
    ...
    <>
      ...
      <section className="bg-secondary/40">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center md:py-24">
          <SectionHeading
            eyebrow={s('your-story').eyebrow ?? 'Your Story Next'}
            title={s('your-story').title ?? 'Ready to write your own success story?'}
            description={s('your-story').description ?? "Book a free assessment and let's map out your journey to the right university."}
          />
          <div className="mt-8">
