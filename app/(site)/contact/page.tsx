...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with EduCoach Services. Call, WhatsApp, email or visit our office — our counsellors are ready to guide your study abroad journey.",
}
  ...
  return (
    <>
      <PageHero
        ...
        description="Have a question about studying abroad? Reach out through any channel — we typically reply within one business day."
      />
