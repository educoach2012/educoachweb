...
import { getSteps, getSiteSettings } from '@/lib/data'

export const metadata: Metadata = {
  title: 'How We Work',
  description:
    'Discover EduCoach\'s 8-step counselling process — from psychometric discovery to departure, every step is guided by a dedicated counsellor.',
}
...
export default async function HowWeWorkPage() {
  ...
  return (
    <>
      <PageHero
        eyebrow="How We Work"
        title="A clear, guided journey to your dream offer"
        description="Eight considered steps. One dedicated counsellor. Zero guesswork."
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4">
          <SectionHeading
            eyebrow="The Process"
            title="From discovery to departure"
            description="Each step builds on the last. Your counsellor stays with you throughout."
          />
      ...
      <CTABand
        ...
        subtitle="Book a free assessment and we'll map your personalised journey."
      />
    </>
  )
}
