      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 pb-16 lg:gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:pb-24">
        <div>
          ...
          >
            ...
            Rated 4.9/5 by 2,500+ students &amp; parents
          </motion.div>
          ...
          >
            ...
            <span className="mt-2 block leading-[1.2]">
              <span className="highlight-gold">Create the right future.</span>
            </span>
          </motion.h1>
          ...
          >
            India&apos;s leading study abroad and career counselling consultancy. From psychometric
