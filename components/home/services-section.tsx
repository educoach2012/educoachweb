...
export function ServicesSection({ services, title, description }: ServicesSectionProps) {
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 sm:py-28">
      <SectionHeading
        eyebrow="Services"
        title={title ?? 'One partner for the entire journey'}
        description={description ?? "Every service is designed to move you closer to the right offer — and a future you're excited about."}
      />
