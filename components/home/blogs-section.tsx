...
export function BlogsSection({ blogs, sectionTitle, sectionDescription }: BlogsSectionProps) {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <SectionHeading
            ...
            title={sectionTitle ?? 'Insights to guide every decision'}
            description={sectionDescription ?? 'Practical, up-to-date advice on admissions, scholarships, tests and more.'}
          />
          <Link
            href="/blogs"
