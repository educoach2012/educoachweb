...
export function WhyEduCoach({ whyCards }: WhyEduCoachProps) {
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 sm:py-28">
      <SectionHeading
        eyebrow="Why EduCoach"
        title="Everything you need, from discovery to departure"
        description="A complete, science-backed system that treats every student as an individual — not an application number."
      />
