...
export function TrustBar({ stats, universities, label }: TrustBarProps) {
  const logos = universities?.length ? universities : defaultLogos
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="mt-12 overflow-hidden">
          <p className="text-center text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">
            {label ?? "Our students study at the world's top universities"}
          </p>
