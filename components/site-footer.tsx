...
export function SiteFooter({ contact, whatsappHref, countries, logoUrl, footerNav, tagline, ctaTitle, ctaSubtitle }: SiteFooterProps) {
        ...
        <div className="grid gap-10 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground">
              {tagline ?? "Helping students discover the right career, build outstanding profiles, and gain admission into the world's leading universities."}
            </p>
